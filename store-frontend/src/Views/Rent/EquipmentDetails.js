...
const EquipmentDetails = ({ route }) => {
  ...
  const deliveryType =
    equipment.deliveryType.charAt(0).toUpperCase() +
    equipment.deliveryType.slice(1); //sets delivery type with uppercase first letter
    ...
    <ScrollView style={styles.container} ref={scrollViewRef}>
      <View style={styles.androidFooterFix}>
        ...
        <View style={styles.card}>
          <Image
            source={{ uri: equipment.imageReference }}
        ...
        >
          <View style={styles.timeContainer}>
            <Text style={styles.title}>
              {deliveryType} Time: {selectedStartTime}
            </Text>
            <Image
        ...
        >
          <View style={styles.timeContainer}>
            <Text style={styles.title}>
              {collectionType} Time: {selectedEndTime}
            </Text>
            <Image
        ...
        {/* Buy Now */}
        <TouchableOpacity
          onPress={isBuyNowEnabled() ? openModal : null}
          style={[
            styles.card,
